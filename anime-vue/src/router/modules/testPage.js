export const testPageRoutes = [
    {
        path: '/test-page',
        name: 'testPage',
        meta: {title: '测试页面1',type:'3',typename:'测试'},
    ...
    },
    {
        path: '/test-table',
        name: 'testTable',
        meta: {title: '测试表格',type:'3',typename:'测试'},
        // 假设您有一个HomeImages组件，这里需要正确导入并使用
    ...
    },
    {
        path: '/test-api',
        name: 'testApi',
        meta: {title: '测试api',type:'3',typename:'测试'},
        // 假设您有一个HomeImages组件，这里需要正确导入并使用
    ...
    },
    {
        ...
        name: 'piniaTestStroe',
        meta: {title: '测试piniastore',type:'3',typename:'测试'},
        // 假设您有一个HomeImages组件，这里需要正确导入并使用
    ...
    },
    {
        ...
        name: 'vuexTestStroe',
        meta: {title: '测试vuexstore',type:'3',typename:'测试'},
        // 假设您有一个HomeImages组件，这里需要正确导入并使用
