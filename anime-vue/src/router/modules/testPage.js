export const testPageRoutes = [
    {
        path: '/test-page',
        name: 'testPage',
        meta: {title: '页面测试',type:'4',typename:'测试'},
    ...
    },
    {
        path: '/test-table',
        name: 'testTable',
        meta: {title: '表格测试',type:'4',typename:'测试'},
        // 假设您有一个HomeImages组件，这里需要正确导入并使用
    ...
    },
    {
        path: '/test-api',
        name: 'testApi',
        meta: {title: 'api测试',type:'4',typename:'测试'},
        // 假设您有一个HomeImages组件，这里需要正确导入并使用
    ...
    },
    {
        ...
        name: 'piniaTestStroe',
        meta: {title: 'piniastore测试',type:'4',typename:'测试'},
        // 假设您有一个HomeImages组件，这里需要正确导入并使用
    ...
    },
    {
        ...
        name: 'vuexTestStroe',
        meta: {title: 'vuexstore测试',type:'4',typename:'测试'},
        // 假设您有一个HomeImages组件，这里需要正确导入并使用
